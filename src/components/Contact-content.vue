<template>
  <div class="contct_content-parrent">
    <div class="line" />
    <div class="content_container">
      ...
      <div class="content_container-bodytext">
        <p class="font-body1">
          I’d love to hear about what you’re working on and how I could help. 
          I’m currently looking for a new role and am open to a wide range of opportunities.
          My preference would be to find a position in a company in London. But I’m also happy to hear about opportunites that don’t fit that description. 
...
.media_icon-github :hover {
    fill: #d0d7de;
}
.media_icon-twitter :hover {
    fill: #1DA1F2;
}

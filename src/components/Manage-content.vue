    ...
    <div class="index_container-2">
      ...
      <div class="imgContainer">
        <picture>
          <source
            ...
            srcset="../assets/images/detail/mobile/image-manage-preview-1@2x.jpg"
          >
          <source
            media="(max-width:768px)"
            srcset="../assets/images/detail/tablet/image-manage-preview-1@2x.jpg"
          >
          <img
      ...
      <div class="imgContainer">
        <picture>
          <source
            media="(max-width:375px)"
            srcset="../assets/images/detail/mobile/image-manage-preview-2@2x.jpg"
          >
          <source
            media="(max-width: 768px)"
            srcset="../assets/images/detail/tablet/image-manage-preview-2@2x.jpg"
          >
          <img
            class="imgContainer-img"
